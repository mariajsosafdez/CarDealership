...
public abstract class Persona {
    ...
    public void setTelefono(String telefono) throws ValidacionException {
        ...
        try {
            long num = Long.parseLong(telefono.trim());
            if (num <= 0) {
                throw new ValidacionException("El teléfono debe ser un número positivo.");
            }
        } catch (NumberFormatException e) {
            throw new ValidacionException("El teléfono debe contener solo dígitos.");
        }
        this.telefono = telefono;
    }
